<form action="" method="post">
    @csrf
    <div class="modal fade" id="editGuru" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3"><label for="exampleFormControlInput1">ID Card</label><input
                                class="form-control" id="exampleFormControlInput1" type="text"
                                placeholder="contoh : 123456789">
                        </div>
                        <div class="mb-3"><label for="exampleFormControlInput1">NIP</label><input class="form-control"
                                id="exampleFormControlInput1" type="text" placeholder="contoh : 123456789">
                        </div>
                        <div class="mb-3"><label for="exampleFormControlInput1">Mata Pelajaran</label><input
                                class="form-control" id="exampleFormControlInput1" type="text"
                                placeholder="contoh : 123456789">
                        </div>
                        <div class="mb-3"><label for="exampleFormControlInput1">Kode</label><input
                                class="form-control" id="exampleFormControlInput1" type="text"
